...
data %>%
  ...
  facet_wrap(~env_var) + 
  theme_bw() +
  labs(title = "Time point of first extinction vs. rate of temperature increase") +
  xlab("rate") + 
...
data %>%
  ...
  facet_wrap(~env_var) + 
  theme_bw() +
  labs(title = "Time point of last extinction vs. rate of temperature increase") +
  xlab("rate") + 
...
data %>%
  ...
  facet_wrap(~env_var) + 
  theme_bw() +
  labs(title = "Time point of average extinction vs. rate of temperature increase") +
  xlab("rate") + 
